import { U as Ut, E as E$1, Q, t as tn, P as Pe, x as xe, Y as Yl, _ as _s } from "./indexhtml-Co3Evg6-.js";
import { g } from "./state-Bmc-LnRe-KqHo9snF.js";
import { u as u$1, v } from "./overlay-monkeypatch-7hGZnbAz-CNQ-42qf.js";
import { o as o$1 } from "./base-panel-BUjfv_Bo-C8fvTxLS.js";
...
let i = class extends o$1 {
  ...
  renderFooter() {
    return this.message === void 0 ? Ut`
          <div class="dialog-footer">
            <vaadin-button
              theme="tertiary"
              @click="${() => E$1.emit("system-info-with-callback", {
  ...
  submit() {
    ...
    E$1.emit("system-info-with-callback", {
      callback: (t) => Pe(`${xe}feedback`, { ...e, versions: t }),
      notify: false
